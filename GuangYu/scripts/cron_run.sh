...
echo "---行者武松---"
python grab_transaction_price.py 5111 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5111 ${yesterday} 10
...
echo "---水浒-顾大嫂---"
python grab_transaction_price.py 5116 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5116 ${yesterday} 10

echo "---李诗诗---"
python grab_transaction_price.py 5108 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5108 ${yesterday} 10

echo "---潘金莲---"
python grab_transaction_price.py 5103 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5103 ${yesterday} 10
...
#--- 趣梦区 ---#
echo "---灵龙王---"
python grab_transaction_price.py 5113 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5113 ${yesterday} 100
...
echo "---黑暗龙王---"
python grab_transaction_price.py 5126 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5126 ${yesterday} 10

echo "---山龙王---"
python grab_transaction_price.py 5130 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5130 ${yesterday} 10

echo "---影龙王---"
python grab_transaction_price.py 5132 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 5132 ${yesterday} 10
...
"5-ShengJingZhiMen" "5-ShuiHu-WuYong" \
...
"5-QianXiZhiZhang" "5-JuYiTing" "5-ShuiHu" "5-NengLiangXuJiDanYuan" "5-LiShiShi" \
"5-BaoZi" "5-XingZheWuSong" "5-ShuiHu-GuDaSao" "5-PanJinLian" "5-DaDaoGuanSheng" \
...
"8-ChuanShuoKaPian" "8-QiaoMingYueYe" "8-XingChenQiYu" \
"8-LongTengHuaXia" "8-ShanHaiJing-BiBi" \
...
"10-LingLongWang" "10-HeiAnLongWang" "10-XiaoXiaoJianPan-FZai" "10-ShanLongWang" "10-YingLongWang"
do
