...
echo "---赛博金刚Mouse---"
python grab_transaction_price.py 4716 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 4716 ${yesterday} 10
...
echo "---赛博Monkey---"
python grab_transaction_price.py 4811 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 4811 ${yesterday} 10
...
echo "---赛博猪八戒---"
python grab_transaction_price.py 4824 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 4824 ${yesterday} 10
...
echo "---机甲铰链---"
python grab_transaction_price.py 4793 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 4793 ${yesterday} 10
...
echo "---源动能---"
python grab_transaction_price.py 4833 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 4833 ${yesterday} 10
...
"6-SaiBoPunK" "6-SaiBoPig" "6-SaiBoQiFeiKa" "6-SaiBoJinGangMouse" "6-SaiBoDog" "6-SaiBoZhanShen" "6-SaiBoMonkey" \
...
"9-YouMingShenPanZhe" "9-YuanDongNeng"
do
