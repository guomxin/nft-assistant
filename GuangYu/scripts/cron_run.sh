...
#------ 工人 ------#
echo "---巧克力工人---"
python grab_transaction_price.py 1108 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1108 ${yesterday} 50

echo "---面包工人---"
python grab_transaction_price.py 1109 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1109 ${yesterday} 50

echo "---布丁工人---"
python grab_transaction_price.py 1110 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1110 ${yesterday} 50

echo "---棉花糖工人---"
python grab_transaction_price.py 1111 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1111 ${yesterday} 50

echo "---奶油工人---"
python grab_transaction_price.py 1112 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1112 ${yesterday} 50
#------ 工人 ------#
...
"19-QiaoKeLiGongRenII" "19-MianBaoGongRenII" "19-BuDingGongRenII" "19-MianHuaTangGongRenII" "19-NaiYouGongRenII" \
"18-AZai" "20-DianDengQi"
do
