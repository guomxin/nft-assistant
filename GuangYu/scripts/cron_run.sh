...
echo "---原几---"
python grab_transaction_price.py 1531 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1531 ${yesterday} 50

echo "---质几---"
python grab_transaction_price.py 1532 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1532 ${yesterday} 50
...
"8-YuEr" "8-JingZhiDiaoJu-KongTou" "8-JingZhiDiaoJu-DuiHuan" "8-XunHangZheI" "9-MengHuanShuiLong" "9-TianShenJuanZhou" "9-JingLingJuanZhou" \
...
"11-MaoXianZheZhiXin" "11-CiOuJingSuiPian" "11-TianChengYiII" "11-TianChengYi" "14-Lv2TianLanShiLaiMu" \
...
"21-TianYuanJing" "21-HunZhu" "21-HuangJinBaoXiang" "21-MiJingBaoXiang" "21-ShenHuaBaoXiang" "21-WenYinBaoXiang" "21-YuanJi" "21-ZhiJi" \
"14-DianJi" "15-WuSeYunNi" "8-MiaoMoXinHua"
do
