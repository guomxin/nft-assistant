...
"6-SaiBoGangTieNiTai" "6-SaiBoFeiXingBaoLei" "6-SaiBoWuShii" "6-SaiBoShiSanQu" \
"6-SaiBoBoLe" "6-SaiBoMoFaYaoShui" "6-SaiBoHuanNiu" "6-SaiBoYuanZiQiShi" \
...
"9-ZiYouZhiShi-HongWenXingTai" "9-HuiLanYaoJi" \
"9-ShuJuDaiMa" "9-SanZuWangLing" "9-JuShuoZhiBi"
do
