...
echo "---音波振荡器---"
python grab_transaction_price.py 4624 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 4624 ${yesterday} 10
...
"6-SaiBoPunK" "6-SaiBoPig" "6-JuChiDuanBi" "6-YinBoZhenDangQi" "6-SaiBoQiFeiKa" "6-SaiBoWuNeng" \
