...
echo "---小小键盘-W仔---"
python grab_transaction_price.py 1629 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1629 ${yesterday} 50

echo "---生命之水---"
python grab_transaction_price.py 1704 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1704 ${yesterday} 100

echo "---钻头---"
python grab_transaction_price.py 1689 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1689 ${yesterday} 100
...
echo "---地方灵镜---"
python grab_transaction_price.py 1710 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1710 ${yesterday} 100

echo "---鸿蒙玉---"
python grab_transaction_price.py 1744 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1744 ${yesterday} 100

echo "---流云盏---"
python grab_transaction_price.py 1739 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1739 ${yesterday} 10

echo "---显形药水---"
python grab_transaction_price.py 1760 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1760 ${yesterday} 10

echo "---第九区地图碎片---"
python grab_transaction_price.py 195 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 195 ${yesterday} 10

echo "---XO研究院---"
python grab_transaction_price.py 1792 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1792 ${yesterday} 100

echo "---引力碎片---"
python grab_transaction_price.py 1784 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1784 ${yesterday} 10

echo "---聚灵珠---"
python grab_transaction_price.py 1753 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1753 ${yesterday} 10

echo "---逆转石---"
python grab_transaction_price.py 1781 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1781 ${yesterday} 10

echo "---一纸诏书---"
python grab_transaction_price.py 1823 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1823 ${yesterday} 10

echo "---穿云号角---"
python grab_transaction_price.py 1825 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1825 ${yesterday} 100

echo "---英雄令---"
python grab_transaction_price.py 1783 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1783 ${yesterday} 10

echo "---琳琅-荆虹---"
python grab_transaction_price.py 1826 ${yesterday} ${yesterday}
python analyze_transaction_prices.py 1826 ${yesterday} 10
...
"11-MaoXianZheZhiXin" "13-ZhuYanZan-San" "13-TianXiangBi-San" "13-YuShiWengZhong-San" "11-HongMengYu" "11-LiuYunZhan" \
"13-ZhanJiaHouTu" "13-QZai" "13-LingBoLianDeng" "11-XianXingYaoShui" "13-DiJiuQuDiTuSuiPian" "13-XOYanJiuYuan" "13-YinLiSuiPian" \
