...
echo "---龙凤守宝---"
python grab_transaction_price.py 1859 ${today} ${tag}
...
echo "---两界灯---"
python grab_transaction_price.py 1857 ${today} ${tag}
...
echo "---电几---"
python grab_transaction_price.py 1541 ${today} ${tag}
...
echo "---冷却液---"
python grab_transaction_price.py 1691 ${today} ${tag}

echo "---大炼金术士---"
python grab_transaction_price.py 1699 ${today} ${tag}

#echo "---葫芦---"
#python grab_transaction_price.py 887 ${today} ${tag}

echo "---暗影花镜---"
python grab_transaction_price.py 1700 ${today} ${tag}

echo "---天圆灵境---"
python grab_transaction_price.py 1702 ${today} ${tag}

echo "---天机牌---"
python grab_transaction_price.py 1125 ${today} ${tag}

echo "---筑颜簪-叁---"
python grab_transaction_price.py 1706 ${today} ${tag}

echo "---添香匕-叁---"
python grab_transaction_price.py 1708 ${today} ${tag}

echo "---玉石翁仲-叁---"
python grab_transaction_price.py 1707 ${today} ${tag}

echo "---小小键盘-W仔---"
python grab_transaction_price.py 1629 ${today} ${tag}

echo "---生命之水---"
python grab_transaction_price.py 1704 ${today} ${tag}

echo "---钻头---"
python grab_transaction_price.py 1689 ${today} ${tag}

echo "---发电机---"
python grab_transaction_price.py 1688 ${today} ${tag}

echo "---人初灵镜---"
python grab_transaction_price.py 1722 ${today} ${tag}

echo "---地方灵镜---"
python grab_transaction_price.py 1710 ${today} ${tag}

echo "---鸿蒙玉---"
python grab_transaction_price.py 1744 ${today} ${tag}

echo "---流云盏---"
python grab_transaction_price.py 1739 ${today} ${tag}

echo "---显形药水---"
python grab_transaction_price.py 1760 ${today} ${tag}

echo "---第九区地图碎片---"
python grab_transaction_price.py 195 ${today} ${tag}

echo "---XO研究院---"
python grab_transaction_price.py 1792 ${today} ${tag}

echo "---引力碎片---"
python grab_transaction_price.py 1784 ${today} ${tag}

echo "---聚灵珠---"
python grab_transaction_price.py 1753 ${today} ${tag}

echo "---逆转石---"
python grab_transaction_price.py 1781 ${today} ${tag}

echo "---一纸诏书---"
python grab_transaction_price.py 1823 ${today} ${tag}

echo "---穿云号角---"
python grab_transaction_price.py 1825 ${today} ${tag}

echo "---英雄令---"
python grab_transaction_price.py 1783 ${today} ${tag}

echo "---琳琅-荆虹---"
python grab_transaction_price.py 1826 ${today} ${tag}

echo "---修行者---"
python grab_transaction_price.py 1835 ${today} ${tag}

echo "---晶能异构体---"
python grab_transaction_price.py 1849 ${today} ${tag}

echo "---蔚蓝之环---"
python grab_transaction_price.py 1852 ${today} ${tag}

echo "---充能晶砂---"
python grab_transaction_price.py 1860 ${today} ${tag}

echo "---分滴秒石---"
python grab_transaction_price.py 1864 ${today} ${tag}

echo "---晶石之漏---"
python grab_transaction_price.py 1865 ${today} ${tag}
