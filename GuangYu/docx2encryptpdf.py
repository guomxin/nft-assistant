...
def convert_file(docx_file_name, pdf_file_name):
...
if __name__ == "__main__":
    ...
    pdf_file_name = "data/日交易额_{}_按交易额排序.pdf".format(
        tag
    ) 
    convert_file(docx_file_name, pdf_file_name)

    docx_file_name = "data/日交易额_{}_按交易量排序.docx".format(
        tag
    )
    pdf_file_name = "data/日交易额_{}_按交易量排序.pdf".format(
        tag
    ) 
    convert_file(docx_file_name, pdf_file_name)
