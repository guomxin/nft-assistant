...
SCAN_URL = "https://confluxscan.io/address/cfx:aapwjebcay7d6jv02whjrrvkm9egmw5fye09cea6zz?NFTAddress=cfx%3Aacdakam9fnb6wa4syv8mpsvg7thda574a67ymag145&limit=50&skip={}&tab=nft-asset"
...
if __name__ == "__main__":
    ...
    fig_cnt_dict = {}
    for (_, name) in idrange.FeiTianPiBa_IdRange2Name.items():
        fig_cnt_dict[name] = 0
    for skip_count in range(0, contract_item_count-NEGLECT_COUNT, 50):
        ...
        for nft in nfts:
            ...
            if flag_pos != -1:
                ...
                for (range, name) in idrange.FeiTianPiBa_IdRange2Name.items():
    ...
    # dump file
    result_file = open("data/_scan_conflux_feitianpiba_result_{}.csv".format(
