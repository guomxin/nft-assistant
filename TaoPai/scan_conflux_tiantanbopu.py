...
SCAN_URL = "https://confluxscan.io/address/cfx:aapwjebcay7d6jv02whjrrvkm9egmw5fye09cea6zz?NFTAddress=cfx%3Aacexxkwh0yr694avgh599ej0gx0kn9871j9nh7rjr0&limit=50&skip={}&tab=nft-asset"
...
def return_fig_count(name):
    if name.endswith("SSS"):
        return 20
    elif name.endswith("SS"):
        return 140
...
if __name__ == "__main__":
    ...
    fig_cnt_dict = {}
    for (_, name) in idrange.TianTanBoPu_IdRange2Name.items():
        fig_cnt_dict[name] = 0
    for skip_count in range(0, contract_item_count-NEGLECT_COUNT, 50):
        ...
        for nft in nfts:
            ...
            if flag_pos != -1:
                ...
                for (range, name) in idrange.TianTanBoPu_IdRange2Name.items():
    ...
    # dump file
    result_file = open("data/_scan_conflux_tiantanbopu_result_{}.csv".format(
