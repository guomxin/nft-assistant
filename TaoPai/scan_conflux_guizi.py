...
SCAN_URL = "https://confluxscan.io/address/cfx:aapwjebcay7d6jv02whjrrvkm9egmw5fye09cea6zz?NFTAddress=cfx%3Aacewxuum66yyw5wzrux05nbt8crdhxu0buf8x381h3&limit=50&skip={}&tab=nft-asset"
...
if __name__ == "__main__":
    ...
    fig_cnt_dict = {}
    for (_, name) in idrange.GuiZi_IdRange2Name.items():
        fig_cnt_dict[name] = 0
    for skip_count in range(0, contract_item_count-NEGLECT_COUNT, 50):
        ...
        for nft in nfts:
            ...
            if flag_pos != -1:
                ...
                for (range, name) in idrange.GuiZi_IdRange2Name.items():
    ...
    # dump file
    result_file = open("data/_scan_conflux_guizi_result_{}.csv".format(
