...
def get_contract_address_ABI_from_name(name):
    if name == "liuangel":
        ...
        return (TaopaiNFT_Contract_Address, TaoPai_ABI)
    elif name == "taopaitest" or name == "taopaishop":
        return (TaopaiNFT_Contract_Address, TaoPai_ABI)
    elif name == "taopaichuangshi":
        return (TaopaiNFT_Contract_Address, TaoPai_ABI)
    elif name == "baibianxiong" or name == "baibianxiong3" or name == "baibianxiongch":
        ...
        or name == "fxfuneng" or name == "fxhe":
        return (FXHE_Contract_Address, TaoPai_ABI)
    elif name == "partycat" or name == "partycategg":
...
def dump_contract_details(contract_address, contract_ABI, dump_file_name, ranges, verbose=True):
    ...
    token_ids = []
    for index in range(0, token_cnt, 5000):
        _, tids = c.call_contract_method(contract_address, contract_ABI, 'tokens', index, 5000)
...
GXGB_Contract_Address = "cfx:acck5bdvy6xd94we1nm1vv80p7b6wyfvh6hbxnha3d"
CYBC_Contract_Address = "cfx:acez76vvhmj121uuhn88wcexs46fzysmxu9jdzbj2r"
XZSD_Contract_Address = "cfx:accrbm9f7rth2je3m9se1ut2f1uhwt325enhtmneys"
ZQYB_Contract_Address = "cfx:acbv00c5ajkseapaj2nc1trcph6hf8xsuyx9zpe4v7"
BJTSG_Contract_Address = "cfx:acdnkc7u6npvjjneupryz9dn0271db0tyj4rxk4b74"
...
SXX_Contract_Address = "cfx:accxfzypd2rpke78m7j4gccx3cmr3xxme60p9hzcdx"
