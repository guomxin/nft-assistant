...
SCAN_URL = "https://confluxscan.io/address/cfx:aapwjebcay7d6jv02whjrrvkm9egmw5fye09cea6zz?NFTAddress=cfx%3Aacgd354zys91dmd56gc049zdv686t9arr6axahp5up&limit=50&skip={}&tab=nft-asset"
...
if __name__ == "__main__":
    ...
    fig_cnt_dict = {}
    for (_, name) in idrange.HuoXingTanCe_IdRange2Name.items():
        fig_cnt_dict[name] = 0
    reach_min_id = False
    for skip_count in range(0, contract_item_count-NEGLECT_COUNT, 50):
        ...
        for nft in nfts:
            ...
            if token_id < MIN_TOKEN_ID:
                ...
                break
            if token_id != None:
                for (range, name) in idrange.HuoXingTanCe_IdRange2Name.items():
    ...
    # dump file
    result_file = open("data/_scan_conflux_huoxingtance_result_{}.csv".format(
