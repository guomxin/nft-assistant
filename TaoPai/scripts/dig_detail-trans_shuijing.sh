...
python diginfo_from_details_conflux.py shuijing 1 data/_details_conflux_shuijing_result_$1.csv 1,12400  ANY $1
...
python diginfo_from_details_conflux.py shuijing 1 data/_details_conflux_shuijing_result_$1.csv 11501,11800 JIXIE $1
python diginfo_from_details_conflux.py shuijing 1 data/_details_conflux_shuijing_result_$1.csv 12301,12400 LIULI $1
...
R-MA\;R-PING\;R-YIN\;R-E\;SR-RUYI\;SSR-RENWU\;WUDAJUXING\;HEIMAO\;JIXIE\;LIULI $1
