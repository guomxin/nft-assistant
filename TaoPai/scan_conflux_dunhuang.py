...
if __name__ == "__main__":
    ...
    fig_cnt_dict = {}
    for (_, name) in idrange.DH_IdRange2Name.items():
        fig_cnt_dict[name] = 0
    for skip_count in range(0, contract_item_count-NEGLECT_COUNT, 50):
        ...
        for nft in nfts:
            ...
            if flag_pos != -1:
                ...
                for (range, name) in idrange.DH_IdRange2Name.items():
    ...
    # dump file
    result_file = open("data/_scan_conflux_dunhuang_result_{}.csv".format(
